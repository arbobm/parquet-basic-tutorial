...
First time I've heard about parquet format was during doing a specialization in Data Science & Analytics last year, on the context of data so big I thought I would never have to deal with it. It turns out our occurrence points datasets and other geodatabases are becoming large enough they could benefit from those strategies.


## What is it?

![](https://www.jumpingrivers.com/blog/parquet-file-format-big-data-r/parquet-logo.png){width=50% fig-align="center"}
...
[Getting started with amazing `sfarrow`](https://wcjochem.github.io/sfarrow/articles/example_sfarrow.html){target="_blank"}
<!-- ### example from real life with range maps? -->


## tidyverse - parquet

There is a [tidyverse parquet package](https://www.tidyverse.org/blog/2025/01/nanoparquet-0-4-0/){target="_blank"} that I haven't tried yet, but they are usually really cool.
